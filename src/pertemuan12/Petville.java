...
@NamedQueries({
   ...
   @NamedQuery(name = "Petville.findByIdPemilik", query = "SELECT p FROM Petville p WHERE p.idPemilik.idPemilik = :idPemilik"),
...
public class Petville implements Serializable {
    ...
    public String toString() {
        return "pertemuan12.Petville[ idHewan=" + idHewan + " ]";
    }
